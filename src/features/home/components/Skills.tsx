    ...
    <div className={cn("flex mx-auto px-8 mt-8", "flex-col")}>
      ...
      <section aria-labelledby="skills" className={cn("text-left text-xl")}>
        <Accordion
          body={
            <>
              ...
              collaborate effectively with other developers, frequently
              practicing pair programming and reviewing{" "}
        ...
        <Accordion
          body={
            <>
              I convey ideas clearly in both written and verbal forms,
              maintaining a{" "}
              <Link
                aria-label="blog"
                className={cn("link")}
        ...
        <Accordion
          body={
            <>
              I ensure my code is robust and maintainable by adopting a
              functional programming style. I prefer strict typing across the
              tech stack, employ code quality tools like{" "}
              <a
                aria-label="ESLint"
                className={cn("link")}
              ...
              , and take a layered approach to testing. I take care to document
              my solutions, and continually address technical debt. By taking
              initiative with {/* // eslint-disable-next-line max-len */}
              <Tooltip
                isInverted
                text="DX"
                tooltip="Developer Experience"
              />{" "}
